  ...
  -
    ...
    items:
      -
        ...
        logo: logoipsum-426.svg
        scale: medium
        type: item
        enabled: true
        logo_height: 2.0
      -
        id: DUXGQSImtTOx4SK0u5QXe
        logo: logoipsum-427.svg
        scale: large
        type: item
        enabled: true
        logo_height: 2.8
      -
        id: udDQDpyjaGMs9_33ZVlQv
        logo: logoipsum-421.svg
        scale: small
        type: item
        enabled: true
        logo_height: 1.8
      -
        id: Y7U8-Couf8f4FSUrzhbjx
        logo: logoipsum-404.svg
        scale: large
        type: item
        enabled: true
        logo_height: 2.5
